...
class CabWrapper:
    ...
    def format(self, format):
        if(format in ['json','text','csv', 'raw','ltwxml']):
...
if __name__ == "__main__":
    ...
    try:
        ...
        print('cab-webservice.py -a <analyzer> -f <format> -o <output> -t <text>')
        sys.exit(2)
    print(opts)
    for opt, arg in opts:
        if opt in ("-h", "--help"):
            print('Help: cab-webservice.py -a <analyzer> -f <format> -o <output> -t <text>')
            sys.exit()
